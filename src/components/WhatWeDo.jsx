...
const WhatWeDo = () => {
  return (
    <section
      id="whatwedo"
      className="bg-gradient-to-r from-[#2d0055] to-[#1b0051] text-white py-20 px-6"
    >
      <div className="text-center max-w-4xl mx-auto mb-12">
        <h2 className="text-3xl font-bold mb-4">What We Do</h2>
        <h3 className="text-2xl font-semibold">
          <span className="ml-[-1000px] border-l-4 border-purple-300 pl-4 inline-block">
            Center of Excellence
          </span>
        </h3>
        <p className="ml-[-350px] mt-4 text-lg font-medium">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 max-w-6xl mx-auto text-center">
        {items.map((item, idx) => (
          <div key={idx} className="flex flex-col items-center space-y-4 px-4">
