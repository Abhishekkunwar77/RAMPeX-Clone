      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="flex justify-end">
            <FaQuoteRight className="mb-[20px] text-4xl text-[#143075]" />
          </div>
        </div>
      </div>
    </section>
